...
public class MyTraderSpi extends JCTPTraderSpi {
	...
	public MyTraderSpi(JCTPTraderApi traderApi,HugeChanceApp hugeChanceApp) {
...
//		traderApi.reqOrderInsert(pInputOrder, ++nRequestID);
	...
	public void onRspUserLogin(CThostFtdcRspUserLoginField pRspUserLogin,
	    ...
	    hugeChanceApp.onRspUserLogin(pRspUserLogin, pRspInfo, nRequestID, bIsLast);
...
//		traderApi.reqOrderInsert(inputOrderField, ++nRequestID);
	...
	public void onRtnOrder(CThostFtdcOrderField pOrder) {
	    ...
	    hugeChanceApp.onRtnOrder(pOrder);
	}
	
	@Override
	public void onRspOrderInsert(CThostFtdcInputOrderField pInputOrder,
			CThostFtdcRspInfoField pRspInfo, int nRequestID, boolean bIsLast) {
	    hugeChanceApp.onRspOrderInsert(pInputOrder,pRspInfo,nRequestID,bIsLast);
	}
	...
	public void onRspOrderAction(
			...
			CThostFtdcRspInfoField pRspInfo, int nRequestID, boolean bIsLast) {
	    hugeChanceApp.onRspOrderAction(pInputOrderAction,pRspInfo,nRequestID,bIsLast);
		
	}
	
	@Override
	public void onRtnTrade(CThostFtdcTradeField pTrade) {
	    hugeChanceApp.onRtnTrade(pTrade);
	}
...
//		System.out.println("持仓明细查询回调");
	    hugeChanceApp.onRspQryInvestorPositionDetail(pInvestorPositionDetail,pRspInfo,nRequestID,bIsLast);
	}
...
//		System.out.println("持仓查询回调");
	    hugeChanceApp.onRspQryInvestorPosition(pInvestorPosition, pRspInfo, nRequestID, bIsLast);
	}
...
//		System.out.println("结算单确认回调");
	    hugeChanceApp.onRspSettlementInfoConfirm(pSettlementInfoConfirm, pRspInfo, nRequestID, bIsLast);
	}
...
//		System.out.println("错误回调");
	    hugeChanceApp.onRspError(pRspInfo, nRequestID, bIsLast);
	}
...
//		System.out.println("报单录入错误回调");
	    hugeChanceApp.onErrRtnOrderInsert(pInputOrder, pRspInfo);
	}
	...
	public void onRspQryTradingAccount(CThostFtdcTradingAccountField pTradingAccount, CThostFtdcRspInfoField pRspInfo, int nRequestID, boolean bIsLast) {
	    hugeChanceApp.onRspQryTradingAccount(pTradingAccount, pRspInfo,nRequestID,bIsLast);
    ...
    public void onRspUserLogout(CThostFtdcUserLogoutField pUserLogout, CThostFtdcRspInfoField pRspInfo, int nRequestID, boolean bIsLast) {
        ...
        hugeChanceApp.onRspUserLogout(pUserLogout, pRspInfo, nRequestID, bIsLast);
    }
    ...
    public void onRspQryInstrument(CThostFtdcInstrumentField pInstrument, CThostFtdcRspInfoField pRspInfo,
        ...
        hugeChanceApp.onRspQryInstrument(pInstrument,pRspInfo,nRequestID,bIsLast);
    }
