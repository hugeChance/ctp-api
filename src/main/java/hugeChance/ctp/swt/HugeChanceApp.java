...
import hugeChance.ctp.thread.Listener;
import swing2swt.layout.BorderLayout;

public class HugeChanceApp {
    
    static Logger logger = Logger.getLogger(HugeChanceApp.class);
    ...
    public static void main(String[] args) {
        try {
            HugeChanceApp window = new HugeChanceApp();
            window.open();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public class ConnectCTP implements Runnable{
        ...
        public void run() {
            ...
            traderSpi = new MyTraderSpi(traderApi,HugeChanceApp.this);
