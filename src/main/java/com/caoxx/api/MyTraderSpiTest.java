 ...
 */
public class MyTraderSpiTest extends JCTPTraderSpi {
    
    static Logger logger = Logger.getLogger(MyTraderSpiTest.class);
	...
	public MyTraderSpiTest(JCTPTraderApi traderApi,mainControl mainControl) {
